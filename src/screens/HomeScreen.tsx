      ...
      <div className="app-scroll pb-nav">
        ...
        <div className="mb-8">
          <div className="flex items-end justify-between px-5 mb-3">
            <div>
              <div className="text-[10px] font-mono uppercase tracking-[0.14em] text-obsidian/50">Featured Creators</div>
              <div className="font-display text-xl tracking-tight mt-0.5">Top-booked <span className="italic">creators</span></div>
            </div>
            {featured.length > 0 && (
          ...
          {loading ? (
            <div className="px-5 py-8 flex items-center justify-center gap-2 text-obsidian/40 text-sm font-mono">
              <span className="w-2 h-2 rounded-full bg-obsidian/30 animate-pulse" /> Loading creators...
            </div>
          ) : featured.length === 0 ? (
